...
export const BOTTOM_MARGIN = rem(20);
export const ICON_SIZE = rem(80);
...
export const useGeneralErrorStyles = createStyles(theme => ({
  wrapper: {
    paddingTop: rem(80),
...
export const useSkillsStyles = createStyles(theme => ({
  wrapper: {
    paddingTop: `calc(${theme.spacing.xl} * 4)`,
    paddingBottom: `calc(${theme.spacing.xl} * 4)`,
  },
...
export const useNowStyles = createStyles(theme => ({
  wrapper: {
    paddingTop: `calc(${theme.spacing.xl} * 4)`,
    paddingBottom: `calc(${theme.spacing.xl} * 4)`,
  },
...
export const useScrollProgressBarStyles = createStyles({
  scrollProgressBar: {
    position: 'sticky',
    zIndex: 2,
    top: 0,
